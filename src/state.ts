...
export const categoriesState = selector<Category[]>({
  key: "categories",
  get: () => [
    { id: "coffee", name: "Dịch vụ công", icon: coffeeIcon },
    ...
    return [
      {
        ...
        image: getDummyImage("nophoso.jpg"),
        description,
        categoryId: ["coffee"],
        variants,
      },
      {
        ...
        image: getDummyImage("tracuu.jpg"),
        description,
        categoryId: ["coffee"],
        variants,
      },
      {
        ...
        image: getDummyImage("kiennghi.jpg"),
        description,
        categoryId: ["coffee"],
        variants,
      },
  ...
  default: [
    {
      ...
      image: logo,
      title: "Chào bạn mới",
      content: "Cảm ơn đã sử dụng Lai Châu Số",
    },
    // {
    //   id: 2,
    //   image: logo,
