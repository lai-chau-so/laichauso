...
export function getDummyImage(filename: string) {
  return `https://raw.githubusercontent.com/lai-chau-so/Banner/main/${filename}`;
}
// //lấy file ảnh trực tiếp từ forder trong máy
// export function getDummyImage(filename: string) {
//   // Đường dẫn đến thư mục `images` trong dự án của bạn
//   const imagesDirectory = "/docs/dummy";

//   // Trả về đường dẫn đến tệp ảnh trong thư mục `images`
